...
// импорт страницы Users
import { Users } from "@Pages/Users";
// импорт страницы UsersAdd
import { UsersAdd } from "@Pages/Users";
// импорт страницы Degug
 ...
 */
export default class AdministratorRouting extends React.Component {
  ...
  render() {
    return (
      ...
      <Switch>
        ...
        {/* рендер страницы Users по адресу /disciplines */}
        <Route path="/users">
          <Users />
        </Route>
        {/* рендер страницы UsersAdd по адресу /disciplines */}
        ...
        {/* рендер страницы Debug по адресу /debugx */}
        <Route path="/debugx">
          <Debug />
        </Route>
